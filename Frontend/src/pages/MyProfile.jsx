...
const MyProfile = () => {
    const { userData, setUserData, token, backendUrl1, loadUserProfileData } = useContext(AppContext);
    ...
    const updateUserData = async () => {
        try {
            ...
            const response = await axios.put(`${backendUrl1}/user/updateProfile`, formData, {
                headers: {
            ...
            console.error(error);
            toast.error("null values not allowed");
        }
    };
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
                    ...
                    {isEdit ? (
                        <select
                            ...
                            <option value="">Select Gender</option>  {/* Optional empty selection */}
